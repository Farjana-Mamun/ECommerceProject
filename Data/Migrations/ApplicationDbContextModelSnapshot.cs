...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ECommerceProject.Models.Configuration", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ECommerceProject.Models.SaleDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ECommerceProject.Models.SubCategory", b =>
                {
                    ...
                    b.Property<string>("SubCatategoryName")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
            ...
            modelBuilder.Entity("ECommerceProject.Models.Product", b =>
                {
                    ...
                    b.HasOne("ECommerceProject.Models.Configuration", "Configuration")
                        .WithMany("Products")
                    ...
                    b.HasOne("ECommerceProject.Models.SubCategory", "SubCategories")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("ECommerceProject.Models.PurchaseDetail", b =>
                {
                    ...
                    b.HasOne("ECommerceProject.Models.PurchaseOrder", null)
                        .WithMany("PurchaseDetails")
                        .HasForeignKey("PurchaseOrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ECommerceProject.Models.Unit", null)
                        .WithMany("PurchaseDetails")
            ...
            modelBuilder.Entity("ECommerceProject.Models.PurchaseOrder", b =>
                {
                    b.HasOne("ECommerceProject.Models.Vendor", null)
                        .WithMany("Purchases")
