...
namespace ECommerceProject.Controllers
{
    public class SubCategoriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,SubCatategoryName,CategoryId")] SubCategory subCategory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,SubCatategoryName,CategoryId")] SubCategory subCategory)
        {
