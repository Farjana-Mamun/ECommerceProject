...
namespace ECommerceProject.Controllers
{
    public class ConfigurationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ConfigurationName")] Configuration configuration)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ConfigurationName")] Configuration configuration)
        {
