...
namespace ECommerceProject.Controllers
{
    public class ProductImagesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ProductId,ImageName,ImageCode,ImageSize,ImageExt")] ProductImage productImage)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ProductId,ImageName,ImageCode,ImageSize,ImageExt")] ProductImage productImage)
        {
